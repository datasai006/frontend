            ...
            <Col md={6}>
              <Card className="mb-4 custom-card">
                <Card.Body>
                  ...
                  <Card.Text>
                    Our mission is to provide a seamless and trustworthy
                    platform for buying and selling second-hand cars. We aim to
                    connect sellers with potential buyers, ensuring transparency
            ...
            <Col md={6}>
              <Card className="mb-4 custom-card">
                <Card.Body>
                  ...
                  <Card.Text>
                    We offer a wide range of second-hand cars from various
                    brands, ensuring quality and value for our customers. Our
                    platform provides detailed information on each vehicle,
              ...
              <Card className="mb-4 custom-card">
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    We provide a reliable and efficient service, making car
                    buying and selling a hassle-free experience.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
